...
protocol HMPopUpViewControllerDelegate: class {
    
    /// It is called when pop up is dismissed by tap outside
    func popupViewControllerDidDismiss(sender: HMPopUpViewController)
}

// optional func
extension HMPopUpViewControllerDelegate {
    func popupViewControllerDidDismiss(sender: HMPopUpViewController) {}
}

public class HMPopUpViewController: UIViewController {
    ...
    weak var delegate: HMPopUpViewControllerDelegate?
...
extension HMPopUpViewController: UIGestureRecognizerDelegate {
